...
import re
import numpy as np
from src.model.robots.rex import motor, terrain, mark_constants, rex_constants
        ...
        if reload_urdf:
            if self._self_collision_enabled:
                self.quadruped = self._pybullet_client.loadURDF(
                    pybullet_data.getDataPath() + f"/robots/rex_description/urdf/{mark_constants.MARK_DETAILS['urdf_name'][self.mark]}",
                    init_position,
                    INIT_ORIENTATION,
